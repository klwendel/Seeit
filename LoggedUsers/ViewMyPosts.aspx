<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeFile="ViewMyPosts.aspx.vb" Inherits="LoggedUsers_ViewMyPosts" title="My Posts"%>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:ObjectDataSource ID="ObjectDataSourceMyPosts" runat="server" 
    DataObjectTypeName="Post" DeleteMethod="RemovePost" InsertMethod="InsertPost" 
    OldValuesParameterFormatString="original_{0}" 
    ConflictDetection="OverwriteChanges" SelectMethod="GetPostsByUser" 
    ...
    DataSourceID="ObjectDataSourceMyPosts" 
        DataKeyNames="PostId">
        ...
        <EmptyDataTemplate>
            <span>You do not have any posts yet.</span>
        </EmptyDataTemplate>
        <InsertItemTemplate>
            <span style="">
