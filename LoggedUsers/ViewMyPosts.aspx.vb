...
Partial Class LoggedUsers_ViewMyPosts
    Inherits System.Web.UI.Page

    'Passes the currently logged in user to the select command of the object data source.
    Protected Sub ObjectDataSourceMyPosts_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceSelectingEventArgs) Handles ObjectDataSourceMyPosts.Selecting
    ...
    Protected Sub ObjectDataSourceMyPosts_Updated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ObjectDataSourceMyPosts.Updated
    ...
    Protected Sub ObjectDataSourceMyPosts_Deleted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ObjectDataSourceMyPosts.Deleted
        e.AffectedRows = CType(e.ReturnValue, Integer)
        If e.Exception IsNot Nothing Then
            lblError.Text = "There was a database error." & e.Exception.Message
            e.ExceptionHandled = True
    ...
    Protected Sub ObjectDataSourceMyPosts_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ObjectDataSourceMyPosts.Inserted
        e.AffectedRows = CType(e.ReturnValue, Integer)
        If e.Exception IsNot Nothing Then
            lblError.Text = "There was a database error." & e.Exception.Message
            e.ExceptionHandled = True
        ElseIf e.AffectedRows = 0 Then
            lblError.Text = "The row was not inserted. Another user may have already inserted this post."
        End If
    End Sub
