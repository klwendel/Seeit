<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeFile="ViewRemovedPosts.aspx.vb" Inherits="LoggedAdmin_ViewRemovedPosts" title="Removed Posts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:ObjectDataSource ID="ObjectDataSourceRemovedPosts" runat="server" 
        DataObjectTypeName="Post" DeleteMethod="RevertRemovePost" InsertMethod="InsertPost" 
        OldValuesParameterFormatString="original_{0}" 
        ConflictDetection="CompareAllValues" SelectMethod="GetRemovedPosts" 
    ...
    <asp:ListView ID="ListViewPosts" runat="server" 
        DataSourceID="ObjectDataSourceRemovedPosts" 
        DataKeyNames="PostId">
        ...
        <EditItemTemplate>
            <span>
                ...
                <asp:Label CssClass="control" ID="PostIdLabel" runat="server" Text='<%# Bind("PostId") %>' />
                <br />
        ...
        <EmptyDataTemplate>
            <span>There are no posts that have been removed.</span>
        </EmptyDataTemplate>
        <InsertItemTemplate>
            <span style="">
        ...
        <SelectedItemTemplate>
            ...
            <br />
            <br />
            <asp:Button ID="FavoriteButton" runat="server" Text="Add To Favorites" Visible='<%# user.IsInRole("Administrator") OR user.IsInRole("StandardUser") %>' OnClick="AddToFavorites" />
            ...
            <asp:Button CssClass="button" ID="DeleteButton" runat="server" CommandName="Delete" Text="Undo Remove Post" Visible='<%# user.IsInRole("Administrator") %>'/>
