<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeFile="ViewPostsByCategory.aspx.vb" Inherits="ViewPostsByCategory" title="Posts By Category"%>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:ObjectDataSource ID="ObjectDataSourcePostsByCategory" runat="server" 
        DataObjectTypeName="Post" DeleteMethod="RemovePost" InsertMethod="InsertPost" 
        OldValuesParameterFormatString="original_{0}" 
        ConflictDetection="CompareAllValues" SelectMethod="GetPostsByCategory" 
        TypeName="PostsDataAccess" UpdateMethod="UpdatePost">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownListCategories" 
                Direction="InputOutput" Name="categoryId" PropertyName="SelectedValue" 
                Type="Int32" />
        </SelectParameters>
        <UpdateParameters>
    ...
    <asp:Label CssClass="lbl" ID="lblCategory" runat="server" Text="Categories:"></asp:Label>
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceCategories" runat="server" 
        ...
        TypeName="CategoriesDataAccess"></asp:ObjectDataSource>
    <asp:ListView ID="ListViewPosts" runat="server" 
        DataSourceID="ObjectDataSourcePostsByCategory" DataKeyNames="PostId">
        <AlternatingItemTemplate>
            <span style="">
                <asp:label ID="Label1" runat="server" Text="Post Description:"></asp:label>
                <asp:LinkButton ID="LinkButton1" runat="server" Text='<%# Eval("Description") %>'  CommandName="Select"/>
                <br />
                <asp:label ID="Label2" runat="server" Text="Created by"></asp:label>
                <asp:Label ID="Label3" runat="server" Text='<%# Eval("UserId") %>' />
                <asp:Label ID="Label4" runat="server" Text="on"></asp:Label>
                <asp:Label ID="Label5" runat="server" Text='<%# Eval("DateCreated") %>' />
                <br />
                <br />
            </span>   
        </AlternatingItemTemplate>
        <EditItemTemplate>
            <span>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidatorDescription" runat="server" Text="*" ErrorMessage="The post description is required." ControlToValidate="DescriptionTextBox" CssClass="error" >
        ...
        <EmptyDataTemplate>
            <span>There are no posts within the selected category.</span>
        </EmptyDataTemplate>
        <InsertItemTemplate>
            <span style="">
